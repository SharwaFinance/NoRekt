...
NPM Registry: https://www.npmjs.com/package/@reown/appkit`}},Xe={getCaipTokens(e){if(!e)return;let t={};return Object.entries(e).forEach(([e,n])=>{t[`${Ye.EIP155}:${e}`]=n}),t},isLowerCaseMatch(e,t){return e?.toLowerCase()===t?.toLowerCase()},getActiveNamespaceConnectedToAuth(){let t=r.state.activeChain;return e.AUTH_CONNECTOR_SUPPORTED_CHAINS.find(r=>n.getConnectorId(r)===e.CONNECTOR_ID.AUTH&&r===t)},withRetry({conditionFn:e,intervalMs:t,maxRetries:n}){let r=0;return new Promise(i=>{async function a(){return r+=1,await e()?i(!0):r>=n?i(!1):(setTimeout(a,t),null)}a()})},userChainIdToChainNamespace(t){if(typeof t==`number`)return e.CHAIN.EVM;let[n]=t.split(`:`);return n},getOtherAuthNamespaces(t){return t?e.AUTH_CONNECTOR_SUPPORTED_CHAINS.filter(e=>e!==t):[]},getConnectorStorageInfo(e,n){let r=t.getConnections()[n]??[];return{hasDisconnected:t.isConnectorDisconnected(e,n),hasConnected:r.some(t=>Xe.isLowerCaseMatch(t.connectorId,e))}}};export{u as S,ye as _,We as a,g as b,Z as c,ze as d,Pe as f,xe as g,j as h,Ge as i,He as l,M as m,Ye as n,Ve as o,z as p,Je as r,Ue as s,Xe as t,Be as u,Ae as v,h as x,be as y};